...
val allDrivers = listOf(
    ...
    Driver("nor","Lando","란도","Norris","노리스","NOR",4,"GBR","mclaren",84,1,3,1),
    ...
    Driver("had","Isack","이삭","Hadjar","아드자르","HAD",6,"FRA","redbull",30,0,0,0),
    Driver("alb","Alex","알렉스","Albon","알본","ALB",23,"THA","williams",26,0,0,0),
    Driver("alo","Fernando","페르난도","Alonso","알론소","ALO",14,"ESP","aston",22,0,1,0),
    Driver("bor","Gabriel","가브리엘","Bortoleto","보르톨레토","BOR",5,"BRA","audi",18,0,0,0),
    ...
    Driver("lin","Arvid","아르비드","Lindblad","린트블라드","LIN",37,"GBR","rb",5,0,0,0),
